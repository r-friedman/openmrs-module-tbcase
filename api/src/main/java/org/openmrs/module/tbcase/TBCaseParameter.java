...
public class TBCaseParameter implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	private static Log log = LogFactory.getLog(TBCaseParameter.class);
	...
	public TBCaseParameter() {
	}

	public TBCaseParameter(Integer id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final TBCaseParameter other = (TBCaseParameter) obj;
