...
public class ReportGenerator {
	...
	public static File generate(TBCaseReport report,String outputFormat,String jrxmlUrl) throws IOException{
	...
	for(TBCaseParameter reportParameter:report.getParameters()){
